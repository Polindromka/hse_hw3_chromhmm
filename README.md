...
13 |Enhancer | <ul><li>Заметим, что 13-е состояние наиболее часто встречается на гистоновых модификациях: <ul><li>H3k4me1StdAlnRep1 </li></ul> </li><li>Чаще всего ассоциировано с аннотированным геномом.</li><li>Данное состояние попадает на интрон</li><li>Показывает не очень высокий сигнал сигнал.</li><li>Данное состояние больше всехо похоже на Enhancer, как и состояние 11 и 12</li></ul>| ![Image](/images/image_13.png)
14 |
15 |
